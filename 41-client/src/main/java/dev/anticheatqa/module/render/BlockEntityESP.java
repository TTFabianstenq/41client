...
public class BlockEntityESP extends Module {
   public static final List<class_2338> positions = new ArrayList<>();
   public final Module.NumberSetting radius = new Module.NumberSetting("Chunk Radius", 3.0, 1.0, 8.0, 1.0);
   private int tick;

   public BlockEntityESP() {
      super("Block Entity ESP", "Outlines all block entities in nearby chunks.", Category.RENDER);
   ...
   public String getDisplay() {
      return this.isEnabled() ? "BE:" + positions.size() : "";
   }
}
